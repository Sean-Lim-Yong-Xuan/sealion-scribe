...
const EssayChecker = () => {
  ...
  const handleLoadExample = () => {
    setEssay(
      `Technology has become an essential part of modern education, transforming the way students learn and teachers teach. Online resources, such as educational videos and interactive apps, allow learners to access information anywhere and anytime. This flexibility makes education more inclusive for students with different needs and schedules.

However, too much dependence on technology can reduce students’ ability to think critically. For example, some students rely on AI tools to generate entire essays instead of developing their own writing skills. Teachers also face challenges when trying to ensure students are using technology responsibly.

In conclusion, technology is a powerful tool that has improved access to education, but it must be used wisely. Schools should focus on balancing traditional teaching methods with new digital tools to make sure students learn both knowledge and critical thinking.`
    );
  };
